...
export default async function EvaluacionesPage() {
  ...
  const { data: estudiante } = await supabase
    ...
    .single()
  const [{ data: wcstResults }, { data: fivePointResults }, { data: af5Results }] = await Promise.all([
